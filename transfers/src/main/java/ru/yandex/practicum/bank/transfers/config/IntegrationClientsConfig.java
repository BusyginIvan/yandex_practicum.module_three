...
public class IntegrationClientsConfig {
    private static final String CLIENT_REGISTRATION_ID = "transfers";
    private static final Authentication TRANSFERS_CLIENT_PRINCIPAL =
    ...
    private RestClient oauth2RestClient(String baseUrl) {
        ...
        oauth2Interceptor.setPrincipalResolver(request -> TRANSFERS_CLIENT_PRINCIPAL);
